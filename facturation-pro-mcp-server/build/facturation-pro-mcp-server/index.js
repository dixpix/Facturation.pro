...
import { CallToolRequestSchema, ErrorCode, ListToolsRequestSchema, McpError, ReadResourceRequestSchema, ListResourcesRequestSchema, } from '@modelcontextprotocol/sdk/types.js';
...
class FacturationProServer {
    ...
    setupToolHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            switch (request.params.name) {
                ...
                default:
                    throw new McpError(ErrorCode.MethodNotFound, `Tool inconnu: ${request.params.name}`);
            }
        });
    }
    ...
    async handleCreateCustomer(args) {
        ...
        if (args.first_name)
            customerData.first_name = args.first_name;
        if (args.last_name)
    ...
    async handleUpdateCustomer(args) {
        ...
        if (args.company_name !== undefined)
            customerData.company_name = args.company_name;
        if (args.first_name !== undefined)
            customerData.first_name = args.first_name;
        if (args.last_name !== undefined)
            customerData.last_name = args.last_name;
        if (args.individual !== undefined)
            customerData.individual = args.individual;
        if (args.civility !== undefined)
            customerData.civility = args.civility;
        if (args.email !== undefined)
            customerData.email = args.email;
        if (args.phone !== undefined)
            customerData.phone = args.phone;
        if (args.street !== undefined)
            customerData.street = args.street;
        if (args.city !== undefined)
            customerData.city = args.city;
    ...
    async handleDeleteCustomer(args) {
    ...
    async handleArchiveCustomer(args) {
    ...
    async handleUnarchiveCustomer(args) {
    ...
    async handleUploadCustomerFile(args) {
    ...
    async handleCreateCategory(args) {
        const categoryData = {
            title: args.title,
            status: args.status
        };
    ...
    async handleUpdateCategory(args) {
        const categoryData = {};
        if (args.title)
            categoryData.title = args.title;
        if (args.status !== undefined)
            categoryData.status = args.status;
    ...
    async handleDeleteCategory(args) {
    ...
    async handleCreateSupplier(args) {
        const supplierData = {
            company_name: args.company_name,
            email: args.email || null,
            phone: args.phone || null,
    ...
    async handleUpdateSupplier(args) {
        const supplierData = {};
        if (args.company_name)
            supplierData.company_name = args.company_name;
        if (args.email !== undefined)
            supplierData.email = args.email;
        if (args.phone !== undefined)
            supplierData.phone = args.phone;
        if (args.street !== undefined)
            supplierData.street = args.street;
        if (args.city !== undefined)
            supplierData.city = args.city;
        if (args.zip_code !== undefined)
            supplierData.zip_code = args.zip_code;
        if (args.country !== undefined)
            supplierData.country = args.country;
    ...
    async handleDeleteSupplier(args) {
    ...
    // === MODULE DEVIS - BASIQUES ===
    async handleListQuotes(args) {
        const params = {};
        if (args.page)
            params.page = args.page;
        if (args.with_details !== undefined)
            params.with_details = args.with_details;
        if (args.customer_id)
            params.customer_id = args.customer_id;
        if (args.status)
            params.status = args.status;
        if (args.period_start)
            params.period_start = args.period_start;
        if (args.period_end)
    ...
    async handleUpdateQuote(args) {
        const quoteData = {};
        if (args.customer_id)
            quoteData.customer_id = args.customer_id;
        if (args.title)
            quoteData.title = args.title;
        if (args.penalty)
            quoteData.penalty = args.penalty;
        if (args.information)
            quoteData.information = args.information;
        if (args.quote_status !== undefined)
            quoteData.quote_status = args.quote_status;
        if (args.items)
            quoteData.items = args.items;
    ...
    async handleDownloadQuotePdf(args) {
        const params = {};
        if (args.proforma)
            params.proforma = args.proforma;
    ...
    // === MODULE DEVIS COMPLET ===
    async handleUpdateQuoteStatus(args) {
    ...
    async handleUploadQuoteFile(args) {
        const formData = new FormData();
        formData.append('upload_file', args.file_data);
        formData.append('filename', args.filename);
    ...
    async handleSendQuoteEmail(args) {
        const emailData = {
            email: args.email,
    ...
    async handleListInvoices(args) {
        ...
        if (args.with_details !== undefined)
            params.with_details = args.with_details;
        if (args.with_settlements !== undefined)
            params.with_settlements = args.with_settlements;
        if (args.customer_id)
            params.customer_id = args.customer_id;
        if (args.bill_type)
            params.bill_type = args.bill_type;
        if (args.period_start)
            params.period_start = args.period_start;
        if (args.period_end)
            params.period_end = args.period_end;
    ...
    async handleUpdateInvoice(args) {
        const invoiceData = {};
        if (args.title)
            invoiceData.title = args.title;
        if (args.pay_before)
            invoiceData.pay_before = args.pay_before;
        if (args.due_on)
            invoiceData.due_on = args.due_on;
    ...
    async handleUploadInvoiceFile(args) {
        const formData = new FormData();
        formData.append('filename', args.filename);
        if (args.visible !== undefined)
            formData.append('visible', args.visible.toString());
    ...
    async handleDownloadInvoicePdf(args) {
    ...
    async handleCreateInvoiceRefund(args) {
        const refundData = {
            title: args.title,
    ...
    async handleListInvoiceSettlements(args) {
    ...
    async handleCreateSettlement(args) {
    ...
    async handleGetSettlement(args) {
    ...
    async handleDeleteSettlement(args) {
    ...
    async handleUpdateProduct(args) {
        const productData = {};
        if (args.ref)
            productData.ref = args.ref;
        if (args.title)
            productData.title = args.title;
        if (args.unit_price !== undefined)
            productData.unit_price = args.unit_price;
        if (args.vat !== undefined)
            productData.vat = args.vat;
        if (args.notes)
            productData.notes = args.notes;
    ...
    // === MODULE ACHATS ===
    async handleListPurchases(args) {
        const params = {};
        if (args.page)
            params.page = args.page;
        if (args.supplier_id)
    ...
    async handleUpdatePurchase(args) {
        const purchaseData = {};
        if (args.title)
            purchaseData.title = args.title;
        if (args.total !== undefined)
            purchaseData.total = args.total;
        if (args.vat_amount !== undefined)
            purchaseData.vat_amount = args.vat_amount;
    ...
    async handleUploadPurchaseFile(args) {
        const formData = new FormData();
        formData.append('filename', args.filename);
    ...
    async handleListSubscriptionOrders(args) {
    ...
    // === MODULE SUIVIS COMMERCIAUX ===
    async handleListFollowups(args) {
        let url = `/firms/${FIRM_ID}/followups.json?`;
        const params = [];
        if (args.page)
            params.push(`page=${args.page}`);
        if (args.title)
            params.push(`title=${encodeURIComponent(args.title)}`);
        if (args.status !== undefined)
    ...
    async handleCreateFollowup(args) {
        const followupData = {
            title: args.title
        };
        if (args.status !== undefined)
            followupData.status = args.status;
    ...
    async handleUpdateFollowup(args) {
        const followupData = {};
        if (args.title)
    ...
    async handleDeleteFollowup(args) {
    ...
    async handleSendInvoiceEmail(args) {
        ...
        if (args.bcc)
            emailData.bcc = args.bcc;
        if (args.subject)
            emailData.subject = args.subject;
        if (args.message)
            emailData.message = args.message;
